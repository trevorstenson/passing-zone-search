...
// Last updated: 2025-06-01T03:51:21.753Z
export const passingZonePatterns: JugglingPattern[] = [
  {
    ...
    "searchableContent": "basic elements for take out passing (workshop) this series will help you learn the basic elements you need to know for mastering take out passing patterns (also known as manipulation patterns).\n\n\n\nyou can start practicing these in order or check in the tags which elements you need for the pattern that you want to learn next.\n\n\n\nthe self-substitute:for the self-substitute the manipulator replaces a thrown self with an extra club. this can be in a passing pattern, but you can also practice it with 2 people.communicate beforehand which club you want to substitute (e.g. in 4-count every fourth). in manipulation passing we want to help each other as much as possible, therefore the juggler can throw the selected self with less spin to make the manipulation easier. this throw we call a pelf (pass-self, as it is a self that is now passed to the manipulator).when handing the extra club to the juggler as a replacement make sure to do a clear movement, so the juggler can estimate when and where the club is coming in. the convention is to hand manipulated selfs from above and manipulated passes from below. if the selected self is thrown with the right hand, the manipulator catches it with their left and replaces it with the club in their right hand and vice versa.\n\n\n\n\n\n\n\n\n\nthe pass-substitute:for the pass-substitute the manipulator replaces a thrown pass with an extra club. there are three versions of how to take the club: early, middle or late.the pass-substitute can be done in any count. in the video we show it on 3-count, that way you can practice both sides.\n\n\n\nfor the early substitute the manipulator is grabbing the club on the body before it leaves the hand of the passer. the passer can adapt the force of the movement. the arm should do the regular movement, but less force is needed as the club will not be thrown.the extra club is handed to the other juggler from underneath. the manipulator has the club on the body now, which is perfect for another manipulation. if this is done in a pattern, where the manipulator will start juggling again after, the club might have to be flipped (turned around).\n\n\n\nfor the middle substitute the manipulator holds their free hand in the middle between the two passers. this is a signal, that they want to manipulate the next pass. the passer now throws the selected pass with less spin so it lands in the hand of the manipulator with a quarter of a turn. the extra club is handed to the other juggler from underneath. the manipulator has the club on the handle now, which is perfect if they want to start juggling again, but must be flipped for another manipulation.the middle substitute is often recommended as it gives the manipulator significantly more time.\n\n\n\nin some pattern it might come in handy to do a late substitute. for this, the manipulator places themself next to the receiving juggler. they catch the selected throw like a normal pass, and hand their extra club to the passer next to them. this can make sense in a pattern where the next step is replacing the receiving juggler, but is less common.\n\n\n\nfor all manipulation the convention is that when manipulating a pass from the right hand, the manipulator receives the club in their left and gives with their right hand. after a manipulation you usually have a zip (repositioning the club from one hand to the other). this can be adapted if it makes sense for the pattern.\n\n\n\n\n\n\n\n\n\nthe pop:\n\n\n\nthe pop is a kind of substitute where each of the jugglers only uses one hand for the club exchange. it is usually followed by the manipulator and the passer changing position. for the pop it is very important that the manipulator makes a clear movement when handing the club. this helps to get the timing right. the passer throws their club as a flat (or with a maximum of a quarter turn) and then turns their hand around for receiving the club from the manipulator. the flat should be high enough to create enough time for the exchange.\n\n\n\nwhich hand is used, and which direction the manipulator turns after the pop, differs from pattern to pattern, so it makes sense to practice different variations.\n\n\n\n\n\n\n\n\n\nthe pass ‘n pop practice pattern\n\n\n\nafter mastering these basic elements individually you can start setting them together. we developed a simple practice pattern that put the pop and pass substitute in action. it is based on a 4-count.in the video you can check out the two steps to learn this pattern. it is also possible to combine different elements to a pattern or using these elements on different counts.\n\n\n\n\n\n\n\n\n\nafter mastering this, you can try out two more patterns with a pop:catch the carrot (pops in 3-count): https://passing.zone/catch-the-carrot/dolby 5.1 (pop and ‘starting’ and pass substitute on 5-count): https://passing.zone/dolby-5-1-mit-einzel-und-doppelganger/\n\n\n\nsee more basic elements for take out passing (workshop) wiebke schnapper see more new patterns workshops \"super easy\" beginner manipulation basic elements for take out passing (workshop) wiebke schnapper see more new patterns workshops \"super easy\" beginner manipulation wiebke schnapperwiebke schnapper"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "dumber ways to die (huiiiii) ‘dumb ways to die’ is a 4 person manipulator pattern invented by ed that is based on the civil war feed. \n\n\n\nif you want more people: you can add a second manipulator!there are probably many ways to do this, but psycho and kathi invented this version called “dumber ways to die (huiiiii)”if you want to learn ‘dumb ways to die’ first, check it out here: https://passing.zone/dumb-ways-to-die/\n\n\n\n\n\n\n\n\n\nsee more dumber ways to die (huiiiii) wiebke schnapper https://passing.zone/dumb-ways-to-die/ see more 5 jugglers new patterns patterns 2 manipulators manipulation dumber ways to die (huiiiii) wiebke schnapper https://passing.zone/dumb-ways-to-die/ see more 5 jugglers new patterns patterns 2 manipulators manipulation wiebke schnapperwiebke schnapper"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "recap of passout dreiskau-muckern thanks to the orgas for an awesome passout! anett’s pass-a-match card at the end of every year the passout community comes together to share our love of passing and to celebrate the new year. this year our home for the week was dreiskau-muckern, specifically the ökologisches landwirtschaftsschulheim. over 90 people attended and our busiest day … recap of passout dreiskau-muckern cameron ford see more conventions mixed new patterns cameron fordcameron ford"
  },
  {
    "id": "muckabout",
    "title": "Muckabout",
    ...
    "searchableContent": "muckabout muckabout is a classic manipulator pattern which is described in aiden burn’s “how to steal from your friends”.\n\n\n\nthere are three jugglers juggling a three count feast and two manipulators, one doing right handed six count roundabout and one doing left handed three count roundabout.\n\n\n\na muckabout workshop was given at passout 2024-2025 and the demo team decided to film it too 🙂\n\n\n\nsee more muckabout cameron ford see more 5 jugglers new patterns patterns 2 manipulators roundabout muckabout cameron ford see more 5 jugglers new patterns patterns 2 manipulators roundabout cameron fordcameron ford"
  },
  {
    "id": "three-cylinder",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "three cylinder a small error in crossing wankle engine led to this beauty: a (and a’) stays a “lazy” feeder forever while b, c and m change roles and hands continuously.\n\n\n\nsee more three cylinder juli see more 4 jugglers patterns manipulation scrambled three cylinder juli see more 4 jugglers patterns manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "techno manipulation patterns we were inspired to add a manipulator to techno and came up with four variations! these 8-club patterns were first juggled in albuquerque, new mexico by lana bolin, ian chesser and omar ramirez. we named our favorite variant, techniquerque, after the city of invention itself. \n\n\n\nsee more techno manipulation patterns ian chesser see more 3 jugglers new patterns patterns 4-handed siteswap 8 clubs about ambidextrous manipulation techno manipulation patterns ian chesser see more 3 jugglers new patterns patterns 4-handed siteswap 8 clubs about ambidextrous manipulation ian chesserian chesser"
  },
  {
    "id": "amvos",
    "title": "AMVOS",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "amvos we were looking for a pattern for 5 jugglers without much running and as little manipulation as possible. well, we managed! ambled mini v on socks is a very chill “on socks”. \n\n\n\nsee more amvos juli see more 5 jugglers new patterns patterns ambled manipulation on socks amvos juli see more 5 jugglers new patterns patterns ambled manipulation on socks julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "lazy why not about see more lazy why not about lukas see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation lazy why not about lukas see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation lukaslukas"
  },
  {
    "id": "fcc",
    ...
    "searchableContent": "3-count friction (fcc) fcc is a 8-handed siteswap for 4 people, 8 hands and 13 clubs (^-^) juggled by john, jonathan, tillman and helena during saarcon, aug 2024.\n\n\n\nsee more 3-count friction (fcc) john zobolas see more 4 jugglers new patterns patterns 8-handed siteswap siteswap 3-count friction (fcc) john zobolas see more 4 jugglers new patterns patterns 8-handed siteswap siteswap john zobolasjohn zobolas"
  },
  {
    "id": "cold-shoulder",
    "title": "Cold Shoulder",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "cold shoulder cold shoulder is a new pattern that copies the manipulation of the regular roundabout into a three count base pattern. after a bit of fooling around with different styles of manipulation we came up with a version that doesn’t have zips, therefore contains a magic club that is never thrown – the perfect attribute to make it a beer passing pattern, or in our case an ice cream passing pattern.\n\n\n\nsee more cold shoulder wiebke schnapper see more 3 jugglers new patterns patterns drinking patterns manipulation roundabout cold shoulder wiebke schnapper see more 3 jugglers new patterns patterns drinking patterns manipulation roundabout wiebke schnapperwiebke schnapper"
  },
  {
    "id": "we-will-rock-you",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "we will rock you a very short pattern that we accidentally created at the ejc 2024 while trying to create ambled mini scrambleds, but we ended up arriving at something entirely different.\n\n\n\nsee more we will rock you lukas ambled mini scrambleds see more 5 jugglers new patterns patterns 12 clubs 2 manipulators ambled manipulation we will rock you lukas ambled mini scrambleds see more 5 jugglers new patterns patterns 12 clubs 2 manipulators ambled manipulation lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled mini v (ic ca) ambled mini v is the first pattern to add an extra club to wiebke’s mini scrambled family of patterns, specifically to mini v (#6). since it is shorter than a “full” ambled pattern and has an easier feeding sequence, we might start recommending mini ambleds to people who want to start learning manipulation patterns with double passes.\n\n\n\nsimilar to how there exist more than 27 ambled patterns, there should also be more than 6 “mini ambleds”. does anyone want to find them all? 🙂\n\n\n\nsee more ambled mini v (ic ca) lukas mini scrambled see more 4 jugglers new patterns patterns 11 clubs ambled manipulation scrambled ambled mini v (ic ca) lukas mini scrambled see more 4 jugglers new patterns patterns 11 clubs ambled manipulation scrambled lukaslukas"
  },
  {
    "id": "manege-a-cinq",
    "title": "Manège à cinq",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "manège à cinq manège à cinq is a version of manège à trois with 2 extra manipulators.\n\n\n\nsee more manège à cinq adrian goldwaser see more 5 jugglers new patterns patterns 3 manipulators 4-handed siteswap about manipulation manège à cinq adrian goldwaser see more 5 jugglers new patterns patterns 3 manipulators 4-handed siteswap about manipulation adrian goldwaseradrian goldwaser"
  },
  {
    "id": "scherzo",
    "title": "Scherzo",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scherzo scherzo is a variant of ed’s wonderful “minued“, with a similar “macarena” part and a fun intercept of a pass the beat after a pass substitute.\n\n\n\nsee more scherzo adrian goldwaser minued see more 3 jugglers new patterns patterns manipulation scherzo adrian goldwaser minued see more 3 jugglers new patterns patterns manipulation adrian goldwaseradrian goldwaser"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "more take-outs in 4-handed siteswaps 978-about, 975-about (holy grail about), tips and dreams\n\n\n\n5 years ago nicki wrote an excellent article summarising the progress which had been made on take-outs in 4-handed siteswaps:  https://passing.zone/take-outs-in-4-handed-siteswaps/\n\n\n\nthere was some exciting progress made at the 2024 ejc, so i thought it was time for an update!\n\n\n\nat passout 2018/2019 in krelingen christian from pittsburgh brought the idea of doing take-outs in a 4-handed siteswap and workshopped 726-about, “what’s that about?” and “manège à trois” (786-about), which i really enjoyed. christian also has a page summarising all the different takeouts in 4-handed siteswaps: https://www.cs.cmu.edu/~ckaestne/takeouts.html\n\n\n\nsee more more take-outs in 4-handed siteswaps cameron ford https://passing.zone/take-outs-in-4-handed-siteswaps/ “manège à trois” (786-about) https://www.cs.cmu.edu/~ckaestne/takeouts.html see more 3 jugglers patterns 4-handed siteswap ambidextrous compilation manipulation more take-outs in 4-handed siteswaps cameron ford https://passing.zone/take-outs-in-4-handed-siteswaps/ “manège à trois” (786-about) https://www.cs.cmu.edu/~ckaestne/takeouts.html see more 3 jugglers patterns 4-handed siteswap ambidextrous compilation manipulation cameron fordcameron ford"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "9 club roundabout 9 club roundabout is the classic pattern roundabout with 2 clubs added. the base pattern is 8 club 2 count on doubles.\n\n\n\nit was first juggled for a two rounds by lukas, adrian and cameron at a juggling club in london but they didn’t film it. at the 2023 ejc they finally got two rounds on film.\n\n\n\nthe pattern was first proposed by cameron. there is a trick in 8 club 2 count on doubles where you throw a right handed quad self and your partner responds with a right handed single self. cameron realised you could use this to add two clubs to lots of the classic, right handed, manipulator patterns. this is similar to/inspired by the way triolar (a juggling trio focused on club passing consisting of liza, anna  and ronja ) realised you could add one club to roundabout by throwing a triple self in 7 club 2 count on doubles.\n\n\n\n\n\n\n\ncameron has vague memories of trying some of the “simplified roundabout” patterns from how to steal from your friends with 2 clubs added at the 2019 ejc with andy (and someone else presumably). he also remembers trying one transition of 9 club roundabout at the krelingen passout with becky and jon. he also got a few transitions with danny and brook at a bath upchuck, probably in 2019.\n\n\n\nsee more 9 club roundabout cameron ford see more 3 jugglers new patterns patterns manipulation roundabout 9 club roundabout cameron ford see more 3 jugglers new patterns patterns manipulation roundabout cameron fordcameron ford"
  },
  {
    "id": "holy-grail-about",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "holy grail about holy grail about is a takeout pattern based on the 4-handed siteswap 975, also known as holy grail.\n\n\n\nit was first juggled for a whole round at the 2024 ejc by lukas, adrian and cameron.\n\n\n\naccording to nicki’s article on takeout patterns in 4-handed siteswaps christian predicted that a round of holy grail about would be thrown before the end of 2019, but it took until 2024!\n\n\n\nafter achieving a round adrian, lukas and cameron decided this was they hardest takeout pattern they have done yet (and also the best crowd reaction to getting a round of a pattern!)\n\n\n\n\n\n\n\nsee more holy grail about cameron ford nicki’s article on takeout patterns in 4-handed siteswaps see more 3 jugglers new patterns patterns about siteswap holy grail about cameron ford nicki’s article on takeout patterns in 4-handed siteswaps see more 3 jugglers new patterns patterns about siteswap cameron fordcameron ford"
  },
  {
    "id": "978-about",
    "title": "978 About",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "978 about 978 about is a takeout pattern based on the 4-handed siteswap 978.\n\n\n\nit was first juggled for a whole round at the 2024 ejc by adrian, lukas and cameron.\n\n\n\ndoreen, nicki and cameron juggled it for a third of a round at coastless con 2019, as described here\n\n\n\n\n\n\n\nsee more 978 about cameron ford here see more 3 jugglers new patterns patterns about siteswap 978 about cameron ford here see more 3 jugglers new patterns patterns about siteswap cameron fordcameron ford"
  },
  {
    "id": "wiebkes-waltz",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "wiebke’s waltz wiebke’s waltz is a phoenician waltz inspired take out pattern on a walking pps feed (the same base pattern as zippy)\n\n\n\nit was developed and presented at the 2023 coastless con along with variants in the “wedding waltz” family.\n\n\n\nin the pattern, the carry and steal of the subsequent substitution are replaced with a ‘clink’, to toast the happy couple. this is followed by a phoenetitian waltz turn for another substitute, and a phoenetitian waltz style intercept in preparation for the next clink.\n\n\n\nsee more wiebke’s waltz cameron ford phoenician waltz see more 4 jugglers new patterns patterns ambidextrous manipulation waltz wiebke’s waltz cameron ford phoenician waltz see more 4 jugglers new patterns patterns ambidextrous manipulation waltz cameron fordcameron ford"
  },
  {
    "id": "672-about",
    "title": "672-About",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "672-about doreen was looking for a nice and flowy 5 club base siteswap to -about on. 672 is a really nice choice. it’s easy but can still be nice with a few extra pirouettes and other beautifications.\n\n\n\nsee more 672-about juli see more 3 jugglers new patterns patterns 4-handed siteswap ambidextrous manipulation 672-about juli see more 3 jugglers new patterns patterns 4-handed siteswap ambidextrous manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "super lazy 966-about the “lazy” way to siteswap-abouts is a great adaptation to jugglers who can’t or won’t run around.\n\n\n\n966-about with 5 jugglers is about as lazy as you can get! \n\n\n\nsee more super lazy 966-about juli see more 5 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation super lazy 966-about juli see more 5 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation julijuli"
  },
  {
    "id": "aa799",
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "mayday zap mayday zap is a 6-handed siteswap (global siteswap: a37979999) for 3 people and 8 clubs.  juggled by john, katia and leo on a rainy day in oslo, july 2023, near mayday bar 🙂\n\n\n\nsee more mayday zap john zobolas see more 3 jugglers new patterns patterns 6-handed siteswap mayday zap john zobolas see more 3 jugglers new patterns patterns 6-handed siteswap john zobolasjohn zobolas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "five count popcornabout five count popcorn about it a three person manipulator pattern based on, umm, five count popcorn! this pattern was first juggled by lukas, adrian and cameron at ejc 2022 and then forgotten about for over a year.\n\n\n\nsee more five count popcornabout cameron ford see more 3 jugglers new patterns patterns ambidextrous manipulation popcorn five count popcornabout cameron ford see more 3 jugglers new patterns patterns ambidextrous manipulation popcorn cameron fordcameron ford"
  },
  {
    "id": "fallen-angels",
    "title": "Fallen Angels",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "fallen angels fallen angels is a manipulator pattern where the manipulator is doing left handed champi and the jugglers are juggling a three count vs pass pass self walking feed.\n\n\n\nit was first juggled at the 2024 bjc by jon, ed, katie and cameron. the base pattern was figured out by katie, ed and cameron.\n\n\n\nsee more fallen angels cameron ford champi see more 4 jugglers new patterns patterns manipulation fallen angels cameron ford champi see more 4 jugglers new patterns patterns manipulation cameron fordcameron ford"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "phoenician quickstep phoenician quickstep is a variation on phoenician waltz with an extra club! this pattern was first juggled by helene, adrian and cameron at bjc 2024\n\n\n\nsee more phoenician quickstep cameron ford phoenician waltz see more 3 jugglers new patterns patterns ambidextrous manipulation waltz phoenician quickstep cameron ford phoenician waltz see more 3 jugglers new patterns patterns ambidextrous manipulation waltz cameron fordcameron ford"
  },
  {
    "id": "grosses-chaos",
    "title": "Grosses Chaos",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "grosses chaos just a period 9 siteswap with 7 clubs. what seems to be a quite ordered siteswap when you look at the global notation becomes really chaotic when remembering what you have to do – welcome to the great chaos 🙂\n\n\n\nsee more grosses chaos daniel pels see more 2 jugglers new patterns patterns 4-handed siteswap ambidextrous grosses chaos daniel pels see more 2 jugglers new patterns patterns 4-handed siteswap ambidextrous daniel pelsdaniel pels"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "mini-scrambleds mini-scrambleds is a family of 6 manipulation patterns founded by jugglers in enschede in 2022. they are related to the scrambled series by aiden burns.\n\n\n\nyou can find a notation and explanation in a more theoretical and more practical version. the theory is fun but by no means required to be able to juggle the pattern.\n\n\n\nlist of the 6 mini-scrambled patterns:\n\n\n\nca ia (donkey)cc ib (back-up)cb ic (tosti / swiss knife) ia cc (sunny side up)ib cb (ebay)ic ca (mini v)\n\n\n\n\n\n\n\ntheory:\n\n\n\nthe mini-scrambleds are a result of the experiment to simplify the scrambleds. whether they actually are easier is debatable but at least they are shorter.\n\n\n\nas the scrambleds, the mini-scrambleds are based on a 2-count vs 4-count feed with rotating positions. opposing to the scrambleds it consists of only two passes before it repeats again (a-b and a-c).\n\n\n\nthe manipulation consists of a carry and in intercept. since there are only 2 beats in the mini-scrambleds the substitute that you would find in a scrambled is left out.\n\n\n\nsince we can chose the position of the intercept (a,b or c) and it’s beat (1 or 2) there are 6 possible variations for the mini-scrambled. (as with the scrambled the position of the carry is dependent on the intercept.)\n\n\n\n\n\n\n\nthe actual juggling:\n\n\n\nall mini-scrambleds are 10-club, 4-person patterns with 3 passers and one manipulator.\n\n\n\n\n\n\n\nthe manipulation pattern has 8 beats (only the throws from the right hand are counted, so actually 16 throws) until it repeats again. that means you only have to remember 8 steps. those you can see in the table underneath or in the videos. the shirts of the jugglers is colorcoded, so you can follow the notation easier. red always starts on position a, blue on b, green on c, and yellow as manipulator.\n\n\n\np: pass – the color refers to the juggler the pass goes to\n\n\n\ns: self \n\n\n\nc: carry, this club is brought instead of thrown\n\n\n\npelf: a pass-self that is thrown to the manipulator without spin\n\n\n\n-: only catching\n\n\n\n-(i): only catching/receiving – this is the intercept\n\n\n\nsee more mini-scrambleds wiebke schnapper see more 4 jugglers new patterns patterns manipulation scrambled mini-scrambleds wiebke schnapper see more 4 jugglers new patterns patterns manipulation scrambled wiebke schnapperwiebke schnapper"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "göttinger opernball göttinger opernball is a variation on phoenician waltz with 2 extra manipulators! this pattern is invented in göttingen.\n\n\n\nsee more göttinger opernball piet phoenician waltz see more 5 jugglers new patterns patterns 3 manipulators ambidextrous manipulation waltz göttinger opernball piet phoenician waltz see more 5 jugglers new patterns patterns 3 manipulators ambidextrous manipulation waltz pietpiet"
  },
  {
    "id": "chippy-zippy",
    "title": "Chippy-Zippy",
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled feedie wechsel dich “feedy wechsel dich” is a scrambled v variation that was invented due to a leg injury. now that we were developing “lazy” patterns for jugglers who won’t or can’t walk, we improved on it – by adding a club.  \n\n\n\nsee more ambled feedie wechsel dich juli feedy wechsel dich see more 4 jugglers new patterns patterns ambidextrous ambled manipulation ambled feedie wechsel dich juli feedy wechsel dich see more 4 jugglers new patterns patterns ambidextrous ambled manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "killer bunny about in every manipulation pattern, an intercept must always be followed by a carry. or… must it?\n\n\n\nkiller bunny about is a lab-grown pattern that was designed specifically to answer this question that had baffled passing nerds for centuries. if you want to know the answer, go ahead and juggle the pattern (or simply watch the video). the answer might surprise you!\n\n\n\n\n\n\n\nsee more killer bunny about philip see more 3 jugglers new patterns patterns ambidextrous manipulation zaps killer bunny about philip see more 3 jugglers new patterns patterns ambidextrous manipulation zaps philipphilip"
  },
  {
    "id": "lazy-567-about",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "lazy 567-about the “lazy” way to siteswap-abouts is a great adaptation to jugglers who can’t or won’t run around.\n\n\n\n567-about is nice and easy even without a lazy juggler – and it’s still nice and easy with a lazy juggler!!!\n\n\n\nsee more lazy 567-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation lazy 567-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation julijuli"
  },
  {
    "id": "lazy-96676",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "lazy 96677-about the “lazy” way to siteswap-abouts is a great adaptation to jugglers who can’t or won’t run around.\n\n\n\nand here’s for you, finally an easy siteswap to do the lazy way! as the 9 is being carried, the runners only do 2-count and then have lots (zip-zip-zip) of time to to the carry. \n\n\n\nsee more lazy 96677-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation lazy 96677-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation julijuli"
  },
  {
    "id": "lazy-972",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "lazy 972-about the “lazy” way to siteswap-abouts is a great adaptation to jugglers who can’t or won’t run around.\n\n\n\nplus, it’s a nice way to invite a 4th person into your “-about”. it’s similar to going “on socks” but 1 position stays at their place all the time. by the way, we should mention that the juggling is most advanced in the “lazy” position. \n\n\n\nsee more lazy 972-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation lazy 972-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation julijuli"
  },
  {
    "id": "lazy-97892",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "lazy 97892-about the “lazy” way to siteswap-abouts is a great adaptation to jugglers who can’t or won’t run around.\n\n\n\nplus, it’s a nice way to invite a 4th person into your “-about”. it’s similar to going “on socks” but 1 position stays at their place all the time. by the way, we should mention that the juggling is most advanced in the “lazy” position. \n\n\n\nsee more lazy 97892-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation lazy 97892-about juli see more 4 jugglers new patterns patterns 4-handed siteswap ambidextrous lazy manipulation julijuli"
  },
  {
    "id": "catch-the-carrot",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "catch the carrot ‘catch the carrot’ is an easy pattern with a short sequence, which makes it very beginner friendly.it is a three-person manipulation pattern based on a jim’s 3-count.\n\n\n\nif you are not familiar with the take out element ‘the pop’, you can learn it here as preparation for the pattern:https://passing.zone/the-pop/\n\n\n\nsee more catch the carrot jenny matthiesen https://passing.zone/the-pop/ see more 3 jugglers new patterns patterns \"super easy\" ambidextrous manipulation catch the carrot jenny matthiesen https://passing.zone/the-pop/ see more 3 jugglers new patterns patterns \"super easy\" ambidextrous manipulation jenny matthiesenjenny matthiesen"
  },
  {
    "id": "dumb-ways-to-die",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "dumb ways to die ‘dumb ways to die’ is a new 4 person manipulator pattern invented by ed that is based on the civil war feed. watch out for some dangerous passes throughout the pattern.\n\n\n\n\n\n\n\nsee more dumb ways to die wiebke schnapper see more 4 jugglers new patterns patterns manipulation dumb ways to die wiebke schnapper see more 4 jugglers new patterns patterns manipulation wiebke schnapperwiebke schnapper"
  },
  {
    "id": "champix",
    "title": "Champix",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "champix champix is champi with an extra club.champi is a 3 person pattern composed by ed clark, the extra club was added by cameron ford.first juggled by helena, adrian and cameron at the ramsgate british juggling convention, april 2023. andy helped us practice it.  \n\n\n\nsee more champix cameron ford see more 3 jugglers new patterns patterns manipulation champix cameron ford see more 3 jugglers new patterns patterns manipulation cameron fordcameron ford"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.9 “vegemite toast” sa ic cc learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.9 “vegemite toast” sa ic cc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.9 “vegemite toast” sa ic cc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.8 “right one” sc ic cc learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.8 “right one” sc ic cc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.8 “right one” sc ic cc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.7 “toast” sb ic cc learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.7 “toast” sb ic cc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.7 “toast” sb ic cc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.6 “saibca” sa ib ca learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.6 “saibca” sa ib ca juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.6 “saibca” sa ib ca juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.5 “wust” sc ib ca learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.5 “wust” sc ib ca juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.5 “wust” sc ib ca juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.4 “last one” sb ib ca learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.4 “last one” sb ib ca juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.4 “last one” sb ib ca juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.3 “buddy check” sa ia cb learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.3 “buddy check” sa ia cb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.3 “buddy check” sa ia cb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.2 “panto” sc ia cb learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.2 “panto” sc ia cb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.2 “panto” sc ia cb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #3.1 “anna maria” sb ia cb learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #3.1 “anna maria” sb ia cb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #3.1 “anna maria” sb ia cb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.9 “wankle engine” ic ca sc learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.9 “wankle engine” ic ca sc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.9 “wankle engine” ic ca sc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.8 “3 variation” ic ca sb learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.8 “3 variation” ic ca sb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.8 “3 variation” ic ca sb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.7 “moonwalk” ic ca sa learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.7 “moonwalk” ic ca sa juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.7 “moonwalk” ic ca sa juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.6 “gentle romble” ib cb sc learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.6 “gentle romble” ib cb sc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.6 “gentle romble” ib cb sc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.5 “chopped up b” ib cb sb learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.5 “chopped up b” ib cb sb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.5 “chopped up b” ib cb sb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.4 “b” ib cb sa learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.4 “b” ib cb sa juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.4 “b” ib cb sa juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.3 “ivy” ia cc sc learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.3 “ivy” ia cc sc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.3 “ivy” ia cc sc juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.2 “unscrambled lb” ia cc sb learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.2 “unscrambled lb” ia cc sb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.2 “unscrambled lb” ia cc sb juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #2.1 “around the world” ia cc sa learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #2.1 “around the world” ia cc sa juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #2.1 “around the world” ia cc sa juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.9 “postmen” cb sc ic learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.9 “postmen” cb sc ic juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.9 “postmen” cb sc ic juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.8 “scrambled v” cb sb ic learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.8 “scrambled v” cb sb ic juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.8 “scrambled v” cb sb ic juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.7 “chopped up v” cb sa ic learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.7 “chopped up v” cb sa ic juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.7 “chopped up v” cb sa ic juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.6 “zig zag” cc sc ib learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.6 “zig zag” cc sc ib juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.6 “zig zag” cc sc ib juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.5 “wrong one” cc sb ib learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.5 “wrong one” cc sb ib juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.5 “wrong one” cc sb ib juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.4 “3” cc sa ib learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.4 “3” cc sa ib juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.4 “3” cc sa ib juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.3 “cascia” ca sc ia learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.3 “cascia” ca sc ia juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.3 “cascia” ca sc ia juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.2 “casbia” ca sb ia learn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.2 “casbia” ca sb ia juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.2 “casbia” ca sb ia juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled variation #1.1 “aidan” ca sa ia alternative name: “pirouettes go crazy”\n\n\n\n\nlearn more about all 27 scrambleds\n\n\n\n\nsee more scrambled variation #1.1 “aidan” ca sa ia juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled scrambled variation #1.1 “aidan” ca sa ia juli learn more about all 27 scrambleds see more 4 jugglers patterns 27 manipulation scrambled julijuli"
  },
  {
    "id": "rollabout",
    "title": "RollAbout",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "rollabout rollabout is a 3 person pattern very simular to the roundabout but with a rolling manipulation. have fun with it!\n\n\n\nsee more rollabout ronja siewert see more 3 jugglers new patterns manipulation rollabout ronja siewert see more 3 jugglers new patterns manipulation ronja siewertronja siewert"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "shakshuka – dancing shakshuka is a very tasty israeli breakfast dish – and a very tasty new base feed for 4 person manipulator patterns. \n\n\n\nsee more shakshuka – dancing jenny matthiesen see more 4 jugglers new patterns patterns manipulation shakshuka – dancing jenny matthiesen see more 4 jugglers new patterns patterns manipulation jenny matthiesenjenny matthiesen"
  },
  {
    "id": "cambled-v",
    "title": "Cambled V",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "cambled v cambled v is a 4 person manipulator pattern composed by cameron ford. the manipulation is the same as scrambled v, but the feed has an extra club in. all jugglers throw with their right hand on beat one.\n\n\n\nsee more cambled v cameron ford see more 4 jugglers new patterns patterns manipulation cambled v cameron ford see more 4 jugglers new patterns patterns manipulation cameron fordcameron ford"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled vegemite toast does anyone really like vegemite toast? i only like the ambled version with zero calories!\n\n\n\nsee more ambled vegemite toast juli see more 4 jugglers new patterns patterns ambled manipulation ambled vegemite toast juli see more 4 jugglers new patterns patterns ambled manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "feedy wechsel dich 2-count feed manipulation pattern with a stationary feeder\n\n\n\nsee more feedy wechsel dich sebastian bild see more 4 jugglers new patterns patterns manipulation feedy wechsel dich sebastian bild see more 4 jugglers new patterns patterns manipulation sebastian bildsebastian bild"
  },
  {
    "id": "2p-1-3p-2-benni",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "2p 1 3p 2 “benni” this siteswap has long been around – but now we finally took a nice video in the bodensee \n\n\n\nsee more 2p 1 3p 2 “benni” juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac side-by-side 2p 1 3p 2 “benni” juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac side-by-side julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "2p 1 variations with balls, clubs and penguins 2p 1 is one of the most basic and simple siteswaps – so it’s time to fool around!\n\n\n\nsee more 2p 1 variations with balls, clubs and penguins juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac side-by-side 2p 1 variations with balls, clubs and penguins juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac side-by-side julijuli"
  },
  {
    "id": "2p-1-1-2-michel",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "2p 1 1 2 “michel” michel was asking for a drinking pattern that could be passed with the pandemic still running strong – to each their own bottle now! \n\n\n\nsee more 2p 1 1 2 “michel” juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac side-by-side 2p 1 1 2 “michel” juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac side-by-side julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "3-handed siteswaps 3-handed siteswaps are generated mostly the same way as 4-handed ones – just 1 hand always has a “0”. as 0 is an empty hand in siteswap, the hand with always 0 won’t do anything in the pattern. at the israeli juggling convention in 2022, we had a very sad reason to develop the idea … 3-handed siteswaps juli see more new patterns workshops julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "easy 3 clubs warmup (1.5p) a super easy warmup for beginner (club) jugglers who want to feel out clubs. no juggling skills required!\n\n\n\nsee more easy 3 clubs warmup (1.5p) juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac easy 3 clubs warmup (1.5p) juli see more 2 jugglers new patterns patterns \"super easy\" minis / prechac julijuli"
  },
  {
    "id": "crossed-3v",
    "title": "Crossed 3V",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "crossed 3v yes, it is possible to combine crossed scrambleds. and it’s much more fun because you do all the parts of the pattern whilst the four-person patterns are a bit one-sided. here you can see the combination of crossed v and crossed 3.\n\n\n\nif you want to make it easier, you can go in the other direction instead of running around the feeder.\n\n\n\nas in all the crossed scrambleds there is this one extra self to make the pattern ambidextrous.\n\n\n\nsee more crossed 3v nicki crossed v crossed 3 see more 5 jugglers new patterns patterns ambidextrous crossed manipulation scrambled crossed 3v nicki crossed v crossed 3 see more 5 jugglers new patterns patterns ambidextrous crossed manipulation scrambled nickinicki"
  },
  {
    "id": "gare-du-zap2",
    "title": "Gare du Zap^2",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "gare du zap^2 gare du zap is the 6-handed siteswap a8999 (global), where you locally throw “pass self zap self self”. the pass (3.3 p) should be in the air a little bit longer than a self, the zap is just a little bit faster that a self (2.7 p).\n\n\n\nsee more gare du zap^2 nicki see more 3 jugglers new patterns patterns 6-handed siteswap zaps gare du zap^2 nicki see more 3 jugglers new patterns patterns 6-handed siteswap zaps nickinicki"
  },
  {
    "id": "crossed-3",
    "title": "Crossed 3",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "crossed 3 jenny had the idea of a new twist on the classic scrambled v patterns: the juggler walking over to change the feeder now walks through the pattern to the other side, instead of around the outside. in other words, b walks to stand by a’s right, not to a’s left.\n\n\n\n\n\n\n\nsee more crossed 3 jenny matthiesen scrambled v see more 4 jugglers new patterns patterns ambidextrous crossed manipulation scrambled crossed 3 jenny matthiesen scrambled v see more 4 jugglers new patterns patterns ambidextrous crossed manipulation scrambled jenny matthiesenjenny matthiesen"
  },
  {
    "id": "pi-nician-waltz",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "pi-nician waltz a very fun variation of phoenician waltz. see for yourself how it works.\n\n\n\nsee more pi-nician waltz nicki phoenician waltz see more 3 jugglers new patterns patterns manipulation pi-nician waltz nicki phoenician waltz see more 3 jugglers new patterns patterns manipulation nickinicki"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "shorty a.k.a. 796686867-about a.k.a. quickie download takeout notation\n\n\n\n\na new takeout pattern based on a period 9 base pattern with 7 clubs. i designed the base pattern specifically for shorty so we could have an ambidextrous manipulator pattern that is hard to juggle but easy to remember.\n\n\n\nsee more shorty a.k.a. 796686867-about a.k.a. quickie lukas download takeout notation see more 3 jugglers new patterns patterns 4-handed siteswap ambidextrous manipulation shorty a.k.a. 796686867-about a.k.a. quickie lukas download takeout notation see more 3 jugglers new patterns patterns 4-handed siteswap ambidextrous manipulation lukaslukas"
  },
  {
    "id": "bruned",
    "title": "BrunEd",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "bruned bruned is an ambidextrous 4-person manipulator pattern with five manipulation actions.it is based on the idea of minued, a three-person manipulation pattern based on pass pass self, which was invented by ed clark back in 2015. the base pattern is brunos nightmare in pass pass self.\n\n\n\nsee more bruned nicki minued see more 4 jugglers new patterns patterns ambidextrous bruno manipulation bruned nicki minued see more 4 jugglers new patterns patterns ambidextrous bruno manipulation nickinicki"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "kennedy – helicopter version not the newest, but still a nice pattern for 4 jugglers. 🙂it’s called kennedy and there are two versions available. they are similar but some actions take part at different time. this is the “helicopter” version where the manipulator rotates while handing over a club to the other manipulator.we couldn’t find a video of this variant somwhere online. so we filmed this one. we had a lot of fun filming it. 🙂\n\n\n\nsee more kennedy – helicopter version hoschy see more 4 jugglers new patterns patterns manipulation kennedy – helicopter version hoschy see more 4 jugglers new patterns patterns manipulation hoschyhoschy"
  },
  {
    "id": "gare-du-zap",
    "title": "Gare du Zap",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "gare du zap sorry barbara. i simply forgot to post it on passing.zone. so for all others. this is already a little bit older recorded in spring 2021.\n\n\n\nsee more gare du zap hoschy see more 3 jugglers new patterns patterns 6-handed siteswap gare du zap hoschy see more 3 jugglers new patterns patterns 6-handed siteswap hoschyhoschy"
  },
  {
    "id": "why-not-about",
    "title": "Why Not About",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "why not about like other about-patterns, whynot about has 12 starting positions: 3 persons x 2 positions (straight and cross passes) x 2 sides on which the manipulator can start (left or right of b). with a period of 15 beats between the manipulator changes, a full round takes 180 beats (and 42 seconds) before all jugglers have again reached their starting position.\n\n\n\nsee more why not about philip see more 3 jugglers new patterns patterns ambidextrous manipulation why not about philip see more 3 jugglers new patterns patterns ambidextrous manipulation philipphilip"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "why not zaps?! (85566) another “little” 4-handed siteswap passing with zaps. great for warming up, super nice outdoors pattern, even with windy conditions. \n\n\n\nsee more why not zaps?! (85566) juli see more 2 jugglers new patterns patterns 4-handed siteswap zaps why not zaps?! (85566) juli see more 2 jugglers new patterns patterns 4-handed siteswap zaps julijuli"
  },
  {
    "id": "heffalot-8882225",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "heffalot (8882225) we survived the first year of the pandemic, we are healthy, we are allowed to have a super tiny little juggling convention and we can still pass. \n\n\n\nsee more heffalot (8882225) juli see more 2 jugglers new patterns patterns 4-handed siteswap zaps heffalot (8882225) juli see more 2 jugglers new patterns patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "966-about-on-socks 966-about-on-socks is a 4-person passing pattern with 9 clubs, where every juggler should be able to pass 7 clubs in 3-count with double passes.\n\n\n\n\nsee more 966-about-on-socks nicki see more 3 jugglers 4 jugglers new patterns patterns ambidextrous on socks 966-about-on-socks nicki see more 3 jugglers 4 jugglers new patterns patterns ambidextrous on socks nickinicki"
  },
  {
    "id": "minied",
    "title": "MiniEd",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "minied minied  \n\n\n\nminied is an ambidextrous 4-person manipulator pattern with four manipulation actions.it is based on the idea of minued, a three-person manipulation pattern based on pass pass self, which was invented by ed clark back in 2015.\n\n\n\nsee more minied nicki minued see more 4 jugglers new patterns patterns ambidextrous manipulation minied nicki minued see more 4 jugglers new patterns patterns ambidextrous manipulation nickinicki"
  },
  {
    "id": "halt-mal-kurz",
    "title": "Halt mal kurz",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "halt mal kurz see more halt mal kurz jenny matthiesen see more 4 jugglers patterns ambidextrous manipulation halt mal kurz jenny matthiesen see more 4 jugglers patterns ambidextrous manipulation jenny matthiesenjenny matthiesen"
  },
  {
    "id": "ambled-postmen",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled postmen finally, the post has arrived!\n\n\n\ninitially, we tried several ways of hand-delivering the carried club to b, but then decided that the timing is a little too tight. instead, we opted for air-mail, which gives the manipulator just enough time to turn and catch the chop from a.\n\n\n\nsee more ambled postmen philip see more 4 jugglers patterns ambled manipulation ambled postmen philip see more 4 jugglers patterns ambled manipulation philipphilip"
  },
  {
    "id": "crossed-v",
    "title": "Crossed V",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "crossed v download notation\n\n\n\n\njenny had the idea of a new twist on the classic scrambled v patterns: the juggler walking over to change the feeder now walks through the pattern to the other side, instead of around the outside. in other words, b walks to stand by a’s right, not to a’s left.\n\n\n\nsee more crossed v lukas download notation scrambled v see more 4 jugglers patterns ambidextrous crossed manipulation scrambled crossed v lukas download notation scrambled v see more 4 jugglers patterns ambidextrous crossed manipulation scrambled lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled combination ivy-maria see more ambled combination ivy-maria hoschy see more 5 jugglers patterns 2 manipulators ambled manipulation ambled combination ivy-maria hoschy see more 5 jugglers patterns 2 manipulators ambled manipulation hoschyhoschy"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "reverse roundabout ronja had the amazing idea of taking the classic 4-count roundabout, but juggling it backwards in time! we attempted various options to make this work in our bland, forward-time universe, and settled on this one.\n\n\n\nsee more reverse roundabout lukas 4-count roundabout see more 3 jugglers patterns manipulation reverse roundabout lukas 4-count roundabout see more 3 jugglers patterns manipulation lukaslukas"
  },
  {
    "id": "whynot-triangle",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "“why not” triangle ever been in a fix when 3 people wanted to pass “whynot”? \n\n\n\nsee more “why not” triangle hoschy see more 3 jugglers patterns 6-handed siteswap “why not” triangle hoschy see more 3 jugglers patterns 6-handed siteswap hoschyhoschy"
  },
  {
    "id": "clean-your-clubs",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "clean your clubs! playing around with the “ice cream factory” that is “ivy” on “v”, we noticed a “magic club” that is never thrown. usually that means we´ll get the beer out, soon… well, there being a pandemic on the go, we decided to not break all rules and drink from a single bottle but to rather clean our clubs before handing them to the next person. enjoy!\n\n\n\nsee more clean your clubs! juli see more 5 jugglers drinking patterns manipulation clean your clubs! juli see more 5 jugglers drinking patterns manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled anna maria scrambled anna-maria has always been special to me as i first juggled this pattern with an “old” friend and we named it for her ill daughter, anna-maria (sbiacb). now, we tried one of the possible ambled versions, with the number 9.4 in lucas’ list.\n\n\n\nsee more ambled anna maria juli 9.4 in lucas’ list see more 4 jugglers patterns ambled manipulation ambled anna maria juli 9.4 in lucas’ list see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "756-about-record",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "756-about record see more 756-about record uwe gärtner see more 3 jugglers patterns ambidextrous manipulation 756-about record uwe gärtner see more 3 jugglers patterns ambidextrous manipulation uwe gärtneruwe gärtner"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "minued with tricks we added some tricks to one of ed’s first ambidextrous manipulation patterns: minued.\n\n\n\nsee more minued with tricks lukas minued see more 3 jugglers patterns ambidextrous manipulation minued with tricks lukas minued see more 3 jugglers patterns ambidextrous manipulation lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "chopsticks mit doppelgänger see more chopsticks mit doppelgänger lukas see more 4 jugglers patterns 2 manipulators ambidextrous manipulation chopsticks mit doppelgänger lukas see more 4 jugglers patterns 2 manipulators ambidextrous manipulation lukaslukas"
  },
  {
    "id": "champiv",
    "title": "Champ IV",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "champ iv see more champ iv cameron ford see more 3 jugglers patterns manipulation champ iv cameron ford see more 3 jugglers patterns manipulation cameron fordcameron ford"
  },
  {
    "id": "bookendsabout",
    "title": "Bookendsabout",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "bookendsabout see more bookendsabout cameron ford see more 3 jugglers patterns manipulation bookendsabout cameron ford see more 3 jugglers patterns manipulation cameron fordcameron ford"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "inverted bookendsabout see more inverted bookendsabout cameron ford see more 3 jugglers patterns manipulation inverted bookendsabout cameron ford see more 3 jugglers patterns manipulation cameron fordcameron ford"
  },
  {
    "id": "ambled-lb",
    "title": "Ambled LB",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled lb see more ambled lb juli see more 4 jugglers patterns ambled manipulation ambled lb juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "tiddo’s changeover this is one of the newest patterns to europe (from canada via the usa). it was taught by peter from winconsin at the passout 2019 to 2020 in königswiesen, austria. we are still debating the notation (so that may change), as the manipulation is quite unusual.\n\n\n\nsee more tiddo’s changeover juli see more 3 jugglers patterns ambidextrous manipulation tiddo’s changeover juli see more 3 jugglers patterns ambidextrous manipulation julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "flip flip pass hug (or kiss) a.k.a. pärchen-pattern (2 2 1p 1) another pattern in the “passing for non-jugglers” workshop. it´s super easy – and super cute.\n\n\n\nsee more flip flip pass hug (or kiss) a.k.a. pärchen-pattern (2 2 1p 1) juli see more 2 jugglers patterns \"super easy\" minis / prechac side-by-side flip flip pass hug (or kiss) a.k.a. pärchen-pattern (2 2 1p 1) juli see more 2 jugglers patterns \"super easy\" minis / prechac side-by-side julijuli"
  },
  {
    "id": "sascha",
    "title": "“Sascha”",
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled double trouble (2 substitutes!) see more ambled double trouble (2 substitutes!) lukas see more 4 jugglers patterns ambled manipulation ambled double trouble (2 substitutes!) lukas see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "champv mit doppelgänger download champv mit doppelgänger notation\n\n\n\nsee more champv mit doppelgänger nicki download champv mit doppelgänger notation see more 4 jugglers patterns 2 manipulators ambidextrous manipulation champv mit doppelgänger nicki download champv mit doppelgänger notation see more 4 jugglers patterns 2 manipulators ambidextrous manipulation nickinicki"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "3-count follow-about see more 3-count follow-about nicki see more 4 jugglers patterns ambidextrous manipulation roundabout 3-count follow-about nicki see more 4 jugglers patterns ambidextrous manipulation roundabout nickinicki"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "take-outs in 4-handed siteswaps 756-about, 777-about, 972-about, 978-about\n\n\n\nat the last passout in krelingen christian from pittsburgh brought the idea of doing take-outs in a 4-handed siteswap and workshoped 726-about, “what’s that about?” and “manège à trois” (786-about), which i really enjoyed.\n\n\n\nsee more take-outs in 4-handed siteswaps nicki “manège à trois” (786-about) see more 3 jugglers patterns 4-handed siteswap ambidextrous compilation manipulation take-outs in 4-handed siteswaps nicki “manège à trois” (786-about) see more 3 jugglers patterns 4-handed siteswap ambidextrous compilation manipulation nickinicki"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "dust devil in 3-count dust devil is a very nice walking pattern which was introduced to the passout mailing list in may 2018 by dave and athena davis.\n\n\n\nsee more dust devil in 3-count nicki see more 3 jugglers patterns ambidextrous bruno walking patterns dust devil in 3-count nicki see more 3 jugglers patterns ambidextrous bruno walking patterns nickinicki"
  },
  {
    "id": "ringelrum",
    "title": "Ringelrum",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "ringelrum see more ringelrum hoschy see more 3 jugglers patterns drinking patterns ringelrum hoschy see more 3 jugglers patterns drinking patterns hoschyhoschy"
  },
  {
    "id": "ringelrein",
    "title": "Ringelrein",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "ringelrein see more ringelrein hoschy see more 3 jugglers patterns \"super easy\" ringelrein hoschy see more 3 jugglers patterns \"super easy\" hoschyhoschy"
  },
  {
    "id": "ambled-choptopus",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled choptopus see more ambled choptopus lukas see more 4 jugglers mixed patterns ambled manipulation ambled choptopus lukas see more 4 jugglers mixed patterns ambled manipulation lukaslukas"
  },
  {
    "id": "ambled-sbibca",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled sbibca “back to the future” see more ambled sbibca “back to the future” juli see more 4 jugglers patterns ambled manipulation ambled sbibca “back to the future” juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "brunickolf",
    "title": "Brunickolf",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "brunickolf see more brunickolf nicki see more 5 jugglers patterns ambidextrous bruno manipulation brunickolf nicki see more 5 jugglers patterns ambidextrous bruno manipulation nickinicki"
  },
  {
    "id": "champ-v",
    "title": "ChampV",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "champv champv is a manipulator in 6 clubs pass pass self pass self by cameron ford\ndownload champv notation\n\n\n\nsee more champv juli download champv notation see more 3 jugglers patterns ambidextrous manipulation champv juli download champv notation see more 3 jugglers patterns ambidextrous manipulation julijuli"
  },
  {
    "id": "kittens",
    "title": "Kittens",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "kittens kittens is a pattern from a very small passing convention in perth, australia in 2012. havana feed was popular there and them and some jugglers invented a way to put a manipulator in.\n\n\n\nsee more kittens juli see more 5 jugglers patterns manipulation kittens juli see more 5 jugglers patterns manipulation julijuli"
  },
  {
    "id": "havana-feed",
    "title": "“Havana” Feed",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "“havana” feed see more “havana” feed juli see more 4 jugglers patterns walking patterns “havana” feed juli see more 4 jugglers patterns walking patterns julijuli"
  },
  {
    "id": "pac-man",
    "title": "PAC MAN",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "pac man pac man has always been a fun game and so is the pattern. it was invented for the codarts graduation show in 2017.  basically, pac man connects 2 roundabouts in a cross by a diagonal carry (and a diagonal pass). one group of jugglers always passes on even, the other on odd beats.\n\n\n\nsee more pac man juli see more 6+ jugglers patterns 2 manipulators manipulation roundabout pac man juli see more 6+ jugglers patterns 2 manipulators manipulation roundabout julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "a backcatcher´s guide to chopsticks see more a backcatcher´s guide to chopsticks juli see more 3 jugglers patterns manipulation a backcatcher´s guide to chopsticks juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "champi mit doppelganger “doppelganger” patterns are the rage right now: a second manipulator is added to a 3 juggler pattern. the second manipultor does not “follow” the first, but is synchronized with them. they do the same manipulation on the same hand at the same time, to different passers. \n\n\n\nsee more champi mit doppelganger juli see more 4 jugglers patterns 2 manipulators manipulation champi mit doppelganger juli see more 4 jugglers patterns 2 manipulators manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ivy on v – “ice cream factory” see more ivy on v – “ice cream factory” lukas see more 5 jugglers patterns manipulation scrambled ivy on v – “ice cream factory” lukas see more 5 jugglers patterns manipulation scrambled lukaslukas"
  },
  {
    "id": "ronjabout",
    "title": "Ronjabout",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ronjabout ronjabout is a 3-person pattern that uses the same manipulation sequence as the well-known roundabout, but with an extra club in the base pattern.\n\n\n\nsee more ronjabout lukas see more 3 jugglers patterns manipulation ronjabout lukas see more 3 jugglers patterns manipulation lukaslukas"
  },
  {
    "id": "ambled-panto",
    "title": "Ambled Panto",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled panto see more ambled panto juli see more 4 jugglers patterns ambled manipulation ambled panto juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "scrambled-v",
    "title": "Scrambled V",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled v see more scrambled v juli see more 4 jugglers patterns manipulation scrambled scrambled v juli see more 4 jugglers patterns manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled 3 variation greg’s goal for this passout was to be featured in an ambled video. it was a joy and privilege ambling with you, greg!and i absolutely adore your skirt!\n\n\n\nsee more ambled 3 variation juli see more 4 jugglers patterns ambled manipulation ambled 3 variation juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "bamboozled-panto",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "bamboozled panto see more bamboozled panto juli see more 4 jugglers patterns ambled manipulation bamboozled panto juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "ambled-right-one",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled right one see more ambled right one juli see more 4 jugglers patterns ambled manipulation ambled right one juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "ambled-cascia",
    "title": "Ambled Cascia",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled cascia see more ambled cascia juli see more 4 jugglers patterns ambled manipulation ambled cascia juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "chopsticks",
    "title": "Chopsticks",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "chopsticks this videos shows three patterns from the “chopsticks” family of juggling patterns. they were invented by cameron ford.\n\n\n\nsee more chopsticks juli see more 3 jugglers patterns ambidextrous manipulation chopsticks juli see more 3 jugglers patterns ambidextrous manipulation julijuli"
  },
  {
    "id": "brunicki",
    "title": "Brunicki",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "brunicki brunicki is a 4 person manipulation pattern based on bruno´s 3-count and 6-count feed. it is technically ambidextrous but as the jugglers always stay on their side of the pattern, each jugglers´ part is always on the same hand.\nsee more brunicki juli see more 4 jugglers patterns bruno manipulation brunicki juli see more 4 jugglers patterns bruno manipulation julijuli"
  },
  {
    "id": "ambled-saibca",
    "title": "Ambled Saibca",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled saibca lukas was just a tiny bit late to be in this video…\nanyway, the backflips are nice and they make the timing easy. before juggling the full pattern, team up with your “backflip bro” and practise them!\nsee more ambled saibca juli see more 4 jugglers patterns ambled manipulation ambled saibca juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "ambled-casbia",
    "title": "Ambled Casbia",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled casbia see more ambled casbia juli see more 4 jugglers patterns ambled manipulation ambled casbia juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled gentle romble see more ambled gentle romble juli see more 4 jugglers patterns ambled manipulation ambled gentle romble juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    ...
    "searchableContent": "a walk in the pattern a walk in the pattern is a combination of scrambled saibca and b (ibcbsa). this is a combination that was deemed “impossible” because both manipulators interact with b on beat 2 and with a on beat 3.\n\n\n\nsee more a walk in the pattern juli see more 5 jugglers patterns 2 manipulators scrambled a walk in the pattern juli see more 5 jugglers patterns 2 manipulators scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "966777777 “double banana” a rather difficult but rather nice 7 club siteswap. \n\n\n\nsee more 966777777 “double banana” juli see more 2 jugglers patterns 4-handed siteswap 966777777 “double banana” juli see more 2 jugglers patterns 4-handed siteswap julijuli"
  },
  {
    "id": "7786786786-2",
    "title": "7786786786",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "7786786786 a nice synchronous 7 club passing pattern.\nsee more 7786786786 hoschy see more 2 jugglers patterns 4-handed siteswap synchronous 7786786786 hoschy see more 2 jugglers patterns 4-handed siteswap synchronous hoschyhoschy"
  },
  {
    "id": "ivy-romble",
    "title": "Ivy Romble",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ivy romble see more ivy romble hoschy see more 5 jugglers patterns 2 manipulators manipulation scrambled ivy romble hoschy see more 5 jugglers patterns 2 manipulators manipulation scrambled hoschyhoschy"
  },
  {
    "id": "tadah-pickup",
    "title": "Tadah pickup",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "tadah pickup a trick based on the “hourglass” passing formation with 6 people. in this version we start with 3 clubs each and pick up 4 clubs during the pattern before finishing with a collect.\n\n\n\nsee more tadah pickup lukas see more 6+ jugglers patterns lukaslukas"
  },
  {
    "id": "manege-a-trois",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "manège à trois a manipulation pattern based on french 3-count (siteswap 786).\ndownload takeout notation\n\n\n\n\n\nsee more manège à trois lukas download takeout notation see more 3 jugglers patterns 4-handed siteswap ambidextrous manipulation manège à trois lukas download takeout notation see more 3 jugglers patterns 4-handed siteswap ambidextrous manipulation lukaslukas"
  },
  {
    "id": "splashabout",
    "title": "Splashabout",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "splashabout download takeout notation\n\n\n\n\nsee more splashabout lukas download takeout notation see more 4 jugglers patterns ambidextrous manipulation roundabout splashabout lukas download takeout notation see more 4 jugglers patterns ambidextrous manipulation roundabout lukaslukas"
  },
  {
    "id": "ambled-ivy-b",
    "title": "Ambled Ivy B",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled ivy b see more ambled ivy b lukas see more 5 jugglers patterns ambled manipulation scrambled ambled ivy b lukas see more 5 jugglers patterns ambled manipulation scrambled lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "around the ambled world see more around the ambled world lukas see more 4 jugglers patterns ambled manipulation around the ambled world lukas see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    "id": "ambled-wust",
    "title": "Ambled Wust",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled wust download takeout notation\n\n\n\n\nsee more ambled wust lukas download takeout notation see more 4 jugglers patterns ambled manipulation ambled wust lukas download takeout notation see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    "id": "ambled-ivy",
    "title": "Ambled Ivy",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled ivy download takeout notation\nsee more ambled ivy lukas download takeout notation see more 4 jugglers patterns ambled manipulation ambled ivy lukas download takeout notation see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled chopped up v download takeout notation\n \nsee more ambled chopped up v lukas download takeout notation see more 4 jugglers patterns ambled manipulation ambled chopped up v lukas download takeout notation see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    "id": "ambled-b",
    "title": "Ambled B",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled b see more ambled b lukas see more 4 jugglers patterns ambled manipulation ambled b lukas see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    "id": "ambled-aidan",
    "title": "Ambled Aidan",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled aidan see more ambled aidan lukas see more 4 jugglers patterns ambled manipulation ambled aidan lukas see more 4 jugglers patterns ambled manipulation lukaslukas"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "improve your zaps: 7 clubs 56789 global 56789\nj1(3)x: heff zap pass doublepass self\nj2(3)ll: pass doublepass self heff zap\n\nthe zap is magic. the pattern is tough. it has passes at 3 different heigths, so the timing has to be really good!\n\n\n\nsee more improve your zaps: 7 clubs 56789 juli see more 2 jugglers patterns 4-handed siteswap zaps improve your zaps: 7 clubs 56789 juli see more 2 jugglers patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "improve your zaps: 6 clubs 85566 flux compensation for the last pattern: both zaps are magic.\n\n\n\nsee more improve your zaps: 6 clubs 85566 juli see more 2 jugglers patterns 4-handed siteswap zaps improve your zaps: 6 clubs 85566 juli see more 2 jugglers patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "improve your zaps: 5 clubs 852 global: 852\nj1(3)x: heff zip zap\nj2(3)ll: zap heff zip\n\n\n\nno magic, here.\n\n\n\n\nsee more improve your zaps: 5 clubs 852 juli see more 2 jugglers patterns 4-handed siteswap zaps improve your zaps: 5 clubs 852 juli see more 2 jugglers patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "improve your zaps: 6 clubs 75666 global: 75666\nj1(3)x: pass self self zap self\nj2(3)ll: zap self pass self self\nj1 does crossing zaps – so he does strainght single passes! j2 does straight zaps, so he does crossing single passes.\n\n\n\nsee more improve your zaps: 6 clubs 75666 juli see more 2 jugglers patterns 4-handed siteswap zaps improve your zaps: 6 clubs 75666 juli see more 2 jugglers patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "improve your zaps: 4 clubs 525 global: 525j1(nicki): zap zip zapj2(juli):        zap zap zip\n\n\n\nsee more improve your zaps: 4 clubs 525 juli see more 2 jugglers patterns 4-handed siteswap zaps improve your zaps: 4 clubs 525 juli see more 2 jugglers patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "improve your zaps: 5 clubs 56662 this pattern was a part of the “improving your zaps” workshop by brook & nicki. it is quite easy but more fun than 5 zaps 1-count…the zap is magic. unfortunately we took only super beautiful red clubs to the beach, though.\n\n\n\nsee more improve your zaps: 5 clubs 56662 juli see more 2 jugglers patterns 4-handed siteswap zaps improve your zaps: 5 clubs 56662 juli see more 2 jugglers patterns 4-handed siteswap zaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "colored passing a nice and funny “pattern”. its a bit more like a concentration game 😉\nsee more colored passing hoschy see more 2 jugglers patterns hoschyhoschy"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "passing by colors simons and my favourite warm up passing pattern. for us its meditative to juggle it. 🙂 it trains both hands, your concentration, your periphial view and you will learn to know which club is in which hand. but it is still simple and there is not much to explain.\nsee more passing by colors hoschy see more 2 jugglers patterns hoschyhoschy"
  },
  {
    "id": "j-c-and-a-crown",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "j, c and a crown james and cameron taught a very nice 7 club “righty lefty” passing workshop at berlin convention 2018. i especially enjoyed their way of marking the starting juggler with a crown in their pattern notation.\n\n\n\nsee more j, c and a crown juli see more 2 jugglers patterns 4-handed siteswap compilation j, c and a crown juli see more 2 jugglers patterns 4-handed siteswap compilation julijuli"
  },
  {
    "id": "mini-hoschy",
    "title": "Mini “Hoschy”",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "mini “hoschy” another nice mini. juli and i invented this variation on a sunny day at the goldstrand beach in düsseldorf.\n\n\n\nsee more mini “hoschy” hoschy see more 2 jugglers patterns minis / prechac side-by-side mini “hoschy” hoschy see more 2 jugglers patterns minis / prechac side-by-side hoschyhoschy"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "3 1 1p 2 3p “floyd” – drinking don’t get confused by the active 2. it is technically a 3 1 1p 2 3p variation.\n\n\n\nsee more 3 1 1p 2 3p “floyd” – drinking hoschy see more 2 jugglers patterns \"super easy\" drinking patterns minis / prechac side-by-side 3 1 1p 2 3p “floyd” – drinking hoschy see more 2 jugglers patterns \"super easy\" drinking patterns minis / prechac side-by-side hoschyhoschy"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "shamrock – drinking see more shamrock – drinking hoschy see more 3 jugglers patterns drinking patterns minis / prechac shamrock – drinking hoschy see more 3 jugglers patterns drinking patterns minis / prechac hoschyhoschy"
  },
  {
    "id": "3-3-3-1p-dani-2",
    "title": "3 3 3 1p “Dani”",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "3 3 3 1p “dani” see more 3 3 3 1p “dani” hoschy see more 2 jugglers patterns minis / prechac 3 3 3 1p “dani” hoschy see more 2 jugglers patterns minis / prechac hoschyhoschy"
  },
  {
    "id": "3-2p-2-1p-martin",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "3 2p 2 1p “martin” see more 3 2p 2 1p “martin” hoschy see more 2 jugglers patterns minis / prechac side-by-side 3 2p 2 1p “martin” hoschy see more 2 jugglers patterns minis / prechac side-by-side hoschyhoschy"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "phoenician – roundabout well. we felt we didn´t use our brains enough, so we combined pass pass self takeout “phoenician waltz” with 4-count roundabout. martin´s idea, swisstian loves it and how did i get there???\n\n\n\nsee more phoenician – roundabout juli see more 3 jugglers patterns ambidextrous manipulation phoenician – roundabout juli see more 3 jugglers patterns ambidextrous manipulation julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "easy ball multiplex passing with balls, those patterns are super easy – they can be juggled by non-jugglers, even.\n\n\n\nsee more easy ball multiplex passing juli see more 2 jugglers patterns \"super easy\" minis / prechac side-by-side easy ball multiplex passing juli see more 2 jugglers patterns \"super easy\" minis / prechac side-by-side julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "5 clubs easy shamrock with zaps a very successful “minis for jugglers and non-jugglers” workshop!these guys are now super motivated to juggle!\n\n\n\nsee more 5 clubs easy shamrock with zaps juli see more 3 jugglers patterns \"super easy\" minis / prechac 5 clubs easy shamrock with zaps juli see more 3 jugglers patterns \"super easy\" minis / prechac julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "3 1 1p 2 3p variations “oscar” & “floyd” one siteswap, 2 variations: standing face to face or side by side. both can be “used” to share a bottle of beer!\n\n\n\nsee more 3 1 1p 2 3p variations “oscar” & “floyd” juli see more 2 jugglers patterns \"super easy\" minis / prechac 3 1 1p 2 3p variations “oscar” & “floyd” juli see more 2 jugglers patterns \"super easy\" minis / prechac julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "i didn´t see it coming! did you train dust devil??? good, here is a pattern that adds a backdrop and a drop forward to the dust devil turn…aptly named “i didn´t see it coming!”\n\n\n\nsee more i didn´t see it coming! juli see more 3 jugglers patterns julijuli"
  },
  {
    "id": "dust-devil",
    "title": "Dust Devil",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "dust devil see more dust devil juli see more 3 jugglers patterns julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled 3v on doublesocks if you combine 2 scrambled patterns, you may as well have 2 people “on socks”.or: we are 7. should we split up or can we do something together?\n\n\n\nsee more scrambled 3v on doublesocks jenny diener see more 6+ jugglers patterns 2 manipulators manipulation on socks scrambled scrambled 3v on doublesocks jenny diener see more 6+ jugglers patterns 2 manipulators manipulation on socks scrambled jenny dienerjenny diener"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "y you follow the frog on socks? see more y you follow the frog on socks? jenny diener see more 6+ jugglers patterns 2 manipulators manipulation on socks y you follow the frog on socks? jenny diener see more 6+ jugglers patterns 2 manipulators manipulation on socks jenny dienerjenny diener"
  },
  {
    "id": "phoenician-waltz",
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "3 3p 3p 3 0 0 “nico” see more 3 3p 3p 3 0 0 “nico” juli see more 2 jugglers patterns minis / prechac side-by-side 3 3p 3p 3 0 0 “nico” juli see more 2 jugglers patterns minis / prechac side-by-side julijuli"
  },
  {
    "id": "4-2p-1-1p-malte",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "4 2p 1 1p “malte” a quite easy side-by-side passing pattern.\n\n\n\nsee more 4 2p 1 1p “malte” juli see more 2 jugglers patterns minis / prechac side-by-side 4 2p 1 1p “malte” juli see more 2 jugglers patterns minis / prechac side-by-side julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "4-count roundabout on this years aichtal juggling convention “juggling resort” juli, simon and i decided to give a roundabout workshop. we thought a lot of jugglers there would like this workshop.\n\n\n\nsee more 4-count roundabout hoschy see more 3 jugglers patterns manipulation roundabout 4-count roundabout hoschy see more 3 jugglers patterns manipulation roundabout hoschyhoschy"
  },
  {
    "id": "ambled-3",
    "title": "Ambled 3",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled 3 scrambled 3 with an extra club. note that when c would do l:4x, r:2, r:4p in other ambled patterns to switch sides, here the necessity to do two right hands in a row is solved differently l:3, r:5px, r:2. the pass is substituted, but it is a 5px which is why the manipulator has it for so long that they have to do a self and intercept before they deliver the 5px.\nsee more ambled 3 ed clark see more 4 jugglers patterns ambled manipulation ambled 3 ed clark see more 4 jugglers patterns ambled manipulation ed clarked clark"
  },
  {
    "id": "holy-grail-975",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "holy grail (975) holy grail is probably the most hard well-known 7 club passing pattern (correct me if you know a harder one)! there are no selves, and the three passes are at three different heights (singlepass, doublepass, zap), so the timing is most important. two or more clubs that go to the same receiving hand one after … holy grail (975) juli see more 2 jugglers patterns julijuli"
  },
  {
    "id": "dolby-7-1",
    "title": "Dolby 7.1",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "dolby 7.1 dolby 7.1 is the latest in the series of patterns that have manipulation similar to the classic dolby söround. in this new pattern, we add a club to the dolby 5.1 pattern, first shown in the video of the 9th secret german convention. dolby 5.1, dolby 5.2 and dolby 7.1 were all composed together as a set by ed clark.\n\n\n\nsee more dolby 7.1 ed clark dolby söround. 9th secret german convention see more 3 jugglers patterns manipulation dolby 7.1 ed clark dolby söround. 9th secret german convention see more 3 jugglers patterns manipulation ed clarked clark"
  },
  {
    "id": "dropabout",
    "title": "Dropabout",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "dropabout dropabout is a very nice combination of roundabout and a backdrop line. it’s for 4 jugglers who should be able to do long passes in 4-count, roundabout and backdrops.\n\n\n\nsee more dropabout juli see more 4 jugglers patterns manipulation roundabout dropabout juli see more 4 jugglers patterns manipulation roundabout julijuli"
  },
  {
    "id": "ambled-toast",
    "title": "Ambled Toast",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "ambled toast ambled toast is the second ambled pattern around, after ambled v, of course. ambled patterns are derived from the scrambled series by adding 1 additional club. the runaround consequently becomes a 10 club 2-count runaround.\n\n\n\nsee more ambled toast juli see more 4 jugglers patterns ambled manipulation ambled toast juli see more 4 jugglers patterns ambled manipulation julijuli"
  },
  {
    "id": "zippy",
    "title": "Zippy",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "zippy zippy is the new craze of 2017! invented by dr. ed and taught at passout in cambourne, it went like fire all over german conventions. is it hard? well…if you are used to ambidextrous manipulations as well as 9 club pps runaround – no.\n\n\n\nsee more zippy juli see more 4 jugglers patterns manipulation zippy juli see more 4 jugglers patterns manipulation julijuli"
  },
  {
    "id": "dolby-5-2",
    "title": "Dolby 5.2",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "dolby 5.2 it is debatable whether dolby 5.2 needs his own video – it is a very slight variant of dolby 5.1. still, check it out – it´s a lot less popular right now.\n\n\n\nsee more dolby 5.2 juli see more 3 jugglers patterns manipulation dolby 5.2 juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "nicki´s 3-count roundabout nicki invented this pattern several years ago and taught it around göttingen. now, as ambidextrous manipulations are becoming “en vogue”, he decided to advertise this one. it´s nice!\nsee more nicki´s 3-count roundabout juli see more 3 jugglers patterns manipulation roundabout nicki´s 3-count roundabout juli see more 3 jugglers patterns manipulation roundabout julijuli"
  },
  {
    "id": "zippy_1",
    "title": "Zippy_1",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "zippy_1 as zippy is such a big hit (and we love to juggle it), we thought to imitate aidan and find additional patterns of a zippy series. aidan found 27 scrambled v variations by permutating the possible actions in a 9 club 2-count runaround. as the resulting scrambled v variations have only 3 beats, 3 positions to manipulate (a,b & c) and 3 manipulations (substitute, intercept & carry), this stands to reason.\n\n\n\nsee more zippy_1 juli see more 4 jugglers patterns manipulation zippy zippy_1 juli see more 4 jugglers patterns manipulation zippy julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "mission impossible workshop “takeouts or stealing patterns have been around for a long time already and are still very popular. yet, working with even newly created takeout patterns feels like doing the same fourcount based patterns over and over again. we propose to break this stagnation by leveraging prechac based patterns and make both passers and manipulators do … mission impossible workshop juli see more 3 jugglers patterns workshops manipulation mission impossible workshop juli see more 3 jugglers patterns workshops manipulation julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "casbia on anna-maria i´m getting closer to my goal of having juggled all 27 scrambled variations in time for next year´s ejc. actually, i juggled more than half of them, already, and i´m very motivated for the others – so if you want to learn a new scrambled, just chat to me…now, people are distracting me with their wish to combine scrambleds in previously unknown ways…challenge accepted! here we combined #1.2 casbia with #3.1, which we named “anna-maria” in honor of annchen´s and berengar´s daughter.\n\n\n\nsee more casbia on anna-maria juli see more 5 jugglers patterns 2 manipulators manipulation scrambled casbia on anna-maria juli see more 5 jugglers patterns 2 manipulators manipulation scrambled julijuli"
  },
  {
    "id": "rum-bee",
    "title": "Rum Bee",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "rum bee see more rum bee juli see more 4 jugglers patterns drinking patterns manipulation scrambled rum bee juli see more 4 jugglers patterns drinking patterns manipulation scrambled julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "star – you follow me?! another new pattern – don´t know where it comes from, actually. it´s not ed´s, this time, so i don´t have the notation either. the base pattern is a 4 person shooting star in 4count and with only 10 clubs. before runnig, each juggler passes until having only 1 (not 2) clubs left, then runs … star – you follow me?! juli see more 6+ jugglers patterns manipulation roundabout star – you follow me?! juli see more 6+ jugglers patterns manipulation roundabout julijuli"
  },
  {
    "id": "champi",
    "title": "Champi",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "champi see more champi juli see more 3 jugglers patterns manipulation champi juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
    "id": "y-you-follow-me",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "why you follow me a pattern created in 2013 by ed clark, using aidan notation.the base pattern is a 4 juggler static y passed in 4-count. b is at the back (or foot) of the y, d in the middle of the y, a on the left of the y (from the point of view of d and b) … why you follow me juli see more 6+ jugglers patterns manipulation why you follow me juli see more 6+ jugglers patterns manipulation julijuli"
  },
  {
    "id": "55244-pspss-ck1",
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "55244 (pspss ck#1) martin and me got a little crazy at the super juggling convention and are now planning to juggle and tape some patterns from christian kästner´s compatible siteswaps list. as far as we can, anyway. here´s our first – an easy 4 club one to practise zaps and flips. and yes, that´s martin at the guitar. … 55244 (pspss ck#1) juli see more 2 jugglers patterns compatible siteswaps 55244 (pspss ck#1) juli see more 2 jugglers patterns compatible siteswaps julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "isolating hoschy see more isolating hoschy juli see more 3 jugglers patterns manipulation roundabout isolating hoschy juli see more 3 jugglers patterns manipulation roundabout julijuli"
  },
  {
    "id": "minued",
    "title": "MinuEd",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "minued minued is a manipulation with changeover in passpassself passing. it was developed by ed clark quite recently and now, the race is on to get 2 full rounds on video. the closest call so far is from the states and you can watch them here. caution, they use glittery pink fat ….things.\n\n\n\nsee more minued juli here see more 3 jugglers patterns manipulation minued juli here see more 3 jugglers patterns manipulation julijuli"
  },
  {
    "id": "chopdolby",
    "title": "ChopDolby",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "chopdolby for christian it was absolutely clear he just had to juggle this pattern. i was sure against it as it is a right-left pattern and requires left handed chopabout (which i thought would be super hard).well, finally he convinced me to try and few hours of practice later, we took this video of a full round of chopdolby. next time, we should not go for super hard, we should go for impossible…\n\n\n\nsee more chopdolby juli see more 3 jugglers patterns manipulation chopdolby juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "sm w/ backdrop, backcatch & changeover (a.k.a. batman) originally from the biowup crew, we tried this combination of a standard manipulator and changeover with a backdrop and a backcatch first at the ejc and finally managed to do it on the first night of passout. it´s a fun pattern to do and fancy to watch…\n\n\n\nsee more sm w/ backdrop, backcatch & changeover (a.k.a. batman) juli see more 3 jugglers patterns manipulation sm w/ backdrop, backcatch & changeover (a.k.a. batman) juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "color codes in jim´s 2count see more color codes in jim´s 2count andi nitsche see more 2 jugglers patterns andi nitscheandi nitsche"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "color codes in whynot 2 color code in whynot (pass self pass heff zip) that is reversed by andi (easily).\n\n\n\nsee more color codes in whynot andi nitsche see more 2 jugglers patterns 4-handed siteswap color codes in whynot andi nitsche see more 2 jugglers patterns 4-handed siteswap andi nitscheandi nitsche"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "stern mit loch und saufen oder auch shoting star for christmas, the very first jiu crew got together again and we finally did that one video i was looking forward to for about a year: the five point star with 4 people, a vacant space to run into and a table of shot glasses with rum in the middle. the german name is derived from the non-drinking pattern name “stern mit loch und laufen” and the english name comes from the original “shooting star”. cheers and enjoy!\n\n\n\nsee more stern mit loch und saufen oder auch shoting star juli see more 4 jugglers patterns drinking patterns stern mit loch und saufen oder auch shoting star juli see more 4 jugglers patterns drinking patterns julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "siteswap",
    "searchableContent": "martins 1-count feed pass pass pass pass zip feeding 2 jugglers doing pass self pass heff zip, feeder doing straight passes, feedies cross passes.\n\n\n\nsee more martins 1-count feed andi nitsche see more 3 jugglers patterns compatible siteswaps martins 1-count feed andi nitsche see more 3 jugglers patterns compatible siteswaps andi nitscheandi nitsche"
  },
  {
    "id": "rum-bee-2",
    "title": "RUM BEE",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "rum bee this pattern is the scrambled variation known as “b”. in britain, it´s also known as the “honey bee” and the counting goes “sun, rain, flowers” instead of “1,2,3”. during the carry you´d call “honey” and the bee follows the carry, buzzing. well, the little bee got tired of all that “sun, rain and flowers” stuff – and as all clubs in the scrambleds are magic, at least here the carry can easily be a bottle and it is always neat if a juggler runs after a bottle, right? so, the little bee is now a cheerful alcoholic drinking to the health of its friends…\n\n\n\nsee more rum bee juli see more 4 jugglers patterns drinking patterns manipulation scrambled rum bee juli see more 4 jugglers patterns drinking patterns manipulation scrambled julijuli"
  },
  {
    "id": "3-on-toast",
    "title": "3 on Toast",
    ...
    "difficulty": null,
    "patternType": "scrambled",
    "searchableContent": "3 on toast who thinks that scrambleds are already super complicated?don´t look at this. seriously!\n\n\n\nsee more 3 on toast juli see more 5 jugglers patterns 2 manipulators scrambled 3 on toast juli see more 5 jugglers patterns 2 manipulators scrambled julijuli"
  },
  {
    "id": "kennedy",
    "title": "Kennedy",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "kennedy a video from a great ejc in bruneck, italy!we used the awesome lighted artificial grass football court for a passing session with “kennedy”. the “airplane-version”. by now, there is a video of the kennedy “helicopter version” online, too.\n\n\n\nsee more kennedy juli kennedy “helicopter version” see more 4 jugglers patterns manipulation kennedy juli kennedy “helicopter version” see more 4 jugglers patterns manipulation julijuli"
  },
  {
    "id": "fabi",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "3p 3p 3p 1 “fabi” juli aus ulm mit floyd auf der “more props – more drops” convention in nürtingen 2015 – ganz minimalistisch mit nur 5 keulen unterwegs.\n\n\n\nsee more 3p 3p 3p 1 “fabi” juli see more 2 jugglers patterns minis / prechac side-by-side 3p 3p 3p 1 “fabi” juli see more 2 jugglers patterns minis / prechac side-by-side julijuli"
  },
  {
    "id": "samba-high-5",
    "title": "Samba “High 5”",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "samba “high 5” super small and super easy manipulation in 2-count. just to prove to birgit that we are fast enough!\n\n\n\nsee more samba “high 5” juli see more 4 jugglers patterns manipulation samba “high 5” juli see more 4 jugglers patterns manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "gino´s manipulator juli aus ulm mit marian aus mannheim und maya und christian aus der schweiz in frankreich auf der glühweinconvention 2015.\n\n\n\nsee more gino´s manipulator juli see more 3 jugglers 4 jugglers patterns manipulation gino´s manipulator juli see more 3 jugglers 4 jugglers patterns manipulation julijuli"
  },
  {
    "id": "chopabout",
    "title": "Chop About",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "chop about chopabout is a manipulation based on 4-count. in the base version in this video, the manipulator turns 2.5times in the middle – 4.5 rotations are possible…\n\n\n\nsee more chop about juli see more 3 jugglers patterns manipulation chop about juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
    "id": "la-vache-qui-rit",
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "la vache qui rit la vache qui rit is a pattern by turtur. it´s asymmetric and still both-handed. the clubs of each color always do the same. it´s fun and not too hard to juggle, provided none of the passers get stressed and speed up.\n\n\n\nsee more la vache qui rit juli see more 3 jugglers patterns julijuli"
  },
  {
    "id": "dolby-soeround",
    "title": "Dolby Söround",
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "dolby söround juggled at passout 2014-2015 in someren.\n\n\n\nsee more dolby söround juli see more 3 jugglers patterns manipulation dolby söround juli see more 3 jugglers patterns manipulation julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "manipulation",
    "searchableContent": "scrambled v (312 cc sc ib) ‘chopped toast’ another scrambled for the aidan burns project.\n\n\n\nsee more scrambled v (312 cc sc ib) ‘chopped toast’ juli see more 4 jugglers patterns manipulation scrambled scrambled v (312 cc sc ib) ‘chopped toast’ juli see more 4 jugglers patterns manipulation scrambled julijuli"
  },
  {
  ...
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "6 clubs shamrock the most easy shamrock variations use only 5 clubs – or rather 4 clubs and a bottle 😉 this one has 6 clubs but is till fairly easy. do i need to say it´s a drinking pattern, as well?\n\n\n\nsee more 6 clubs shamrock juli see more 3 jugglers patterns drinking patterns minis / prechac 6 clubs shamrock juli see more 3 jugglers patterns drinking patterns minis / prechac julijuli"
  },
  {
    ...
    "difficulty": null,
    "patternType": "general",
    "searchableContent": "floyd (extended) one of our “drinking patterns” filmed the day it was adapted to the bottle by juli from ulm and floyd from bochum.\n\n\n\nsee more floyd (extended) juli see more 2 jugglers patterns drinking patterns minis / prechac side-by-side floyd (extended) juli see more 2 jugglers patterns drinking patterns minis / prechac side-by-side julijuli"
  }
];
